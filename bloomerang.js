...
'<label for="consent-all"><input id="consent-all" name="consent-all" type="checkbox" maxlength="255"></input><span class="label">I would like to receive or continue receiving updates from Tick Free Martha\'s Vineyard</span></label>' + 
'</div>' + 
...
'      <label id=\'noCaptchaResponseError\' class=\'error noCaptchaResponseError\' style=\'display: none\'>You must fill out the CAPTCHA</label><div id="captcha56320"></div>' + 
'' + 
'</div>' + 
...
'</div>' + 
'<div class="field text payment required" id="one-pay-fields">' + 
'                                    <div class="payment-container">' + 
'                                        <div class="loading-indicator" id="loading-indicator">' + 
'                                            <div class="loading-text">Loading secure checkout frame...</div>' + 
'                                        </div>' + 
'                                        <div id="payments-ui-iframe" style="background: #f8f8f8; width: 100%; max-width: 380px;">' + 
'                                            <iframe id="payments-iframe"' + 
'                                                    style="width:100%; height:650px"' + 
'                                                    frameborder="0"' + 
'                                                    sandbox="allow-same-origin allow-scripts allow-popups allow-forms allow-modals"' + 
'                                                    allow="payment *; encrypted-media *; fullscreen *; accelerometer; autoplay; clipboard-write; picture-in-picture; publickey-credentials-get *; camera *"' + 
...
'' +  '';var successHtml56320 = '<div class=\'donation-success\'>' +
                            ...
                            }if (jQuery('#bloomerangForm56320').length) {
                        
                    if (window.ActiveXObject) { // they are using IE < 11, which doesn't support TLS 1.1
                        html56320 = '<p style="color: red">Your browser does not support the minimum security requirements for keeping your Credit Card information safe when processing payments. Please upgrade your browser or download the latest version of' + 
                        ...
                        jQuery('#bloomerangForm56320').after(html56320);
                        
                        
                        Bloomerang.Util.requireStripe(function() {
                              Bloomerang.useKey('pub_b1b3486a-06bc-11f1-9ea1-06612d4c9559');
                              jQuery("form.donation-form .DebitCard, #donation-form .DebitCard").remove();jQuery("form.donation-form .CreditCard, #donation-form .CreditCard").remove();Bloomerang.Data.PayPal.IsPayPalVenmoEnabled = false;
                                           ...
                                           jQuery("form.donation-form .Venmo, #donation-form .Venmo").remove();jQuery("form.donation-form .section.payment h3, #donation-form .section.payment h3").remove();jQuery("form.donation-form .section.movedpayment h3, #donation-form .section.movedpayment h3").remove();
                              Bloomerang.Util.mountOnePayCheckout('https://1pay.crm.bloomerang.co/checkout/index.html');
...
Bloomerang.Data.PayPal.IsPayPalPaymentMethodVaultingEnabled = false;Bloomerang.Data.PayPal.IsVenmoSameDayDonationEnabled = false;
                    ...
                    if (Bloomerang.paymentFormLoaded) {
                        ...
                        Bloomerang.reCaptchaV3SiteKey = '6LcYqZosAAAAAGisZLsEy9idrMzULuoGRJOK96Ou';
                        ...
                        function initializeCaptcha() {
                            Bloomerang.Util.load('https://www.google.com/recaptcha/api.js?onload=captchaLoadCallback&render=explicit',
                                ...
                                function() {
                                    ...
                                    jQuery('form.donation-form').data('captcha-id', grecaptcha.render('captcha56320', { 'sitekey' : '6LcYqZosAAAAAGisZLsEy9idrMzULuoGRJOK96Ou' }));
                                          ...
                                          grecaptcha.execute(Bloomerang.reCaptchaV3SiteKey, {action: 'submit'}).then(function(token) {
                                              async function success (result) {
                                                if(parseFloat(result.Score) < Bloomerang.gRecaptchaV3Threshold) {
                                                    ...
                                                    jQuery('.donation-form .section.captcha').attr('style', 'display: block');
                                                } else {
        ...
        Bloomerang.Api.OnSuccess = Bloomerang.Widget.Donation.OnSuccess = function (response) {
            ...
            formContainer.show();
            formContainer.html(successHtml56320);
              ...
              jQuery(e).toggle();
                ...
                var startBloomerangLoad = function() {
                    if (window.bloomerangLoadStarted == undefined) {
                        ...
                        script.src = 'https://crm.bloomerang.co/Content/Scripts/Api/Bloomerang-v2.js?nocache=1772807358';
                        document.getElementsByTagName('head')[0].appendChild(script);
                        waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm56320(); })});
                    }
                    else {
                        waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm56320(); })});
                    }
